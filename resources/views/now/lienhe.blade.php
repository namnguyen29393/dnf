<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" ng-app="deliveryNow" class="ng-scope"><!-- Mirrored from www.now.vn/lien-he by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jul 2018 02:37:21 GMT --><!-- Added by HTTrack --><head><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style><meta http-equiv="content-type" content="text/html;charset=utf-8"><!-- /Added by HTTrack -->
    ...
    <link href="now/Content/css/timecircles/TimeCircles.css" rel="stylesheet">
    <link href="now/ating/star-rating.min.css" rel="stylesheet">
    
    
<script async="" src="../www.googletagmanager.com/gtm5445.html?id=GTM-WTB2PQB"></script><script src="file:///C:/Users/Admin/Downloads/now/connect.facebook.net/signals/config/576888802513805?v=2.8.18&amp;r=stable" async=""></script><script async="" src="../connect.facebook.net/en_US/fbevents.js"></script><script async="" src="../www.google-analytics.com/analytics.js"></script><script>
...
<script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/33/7/intl/vi_ALL/common.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/33/7/intl/vi_ALL/util.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/33/7/intl/vi_ALL/stats.js"></script></head>
<body>
...
<form action="https://www.now.vn/da-nang/danh-sach-dia-diem-giao-tan-noi" class="material-search-form material-search-form-hidden ng-pristine ng-valid" id="search-form" method="get">                    <div class="material-search-form-container ng-scope" ng-controller="CompleteController as completeCtrl">
            ...
            <div class="static-container">
                <div class="static-content">
                    <div class="static-area">
                            <div style="width: 100%;">
                                <h1 class="static-headers" style="margin: 10px; padding: 10px;">Liên hệ</h1>
                                <div class="static-ct">
                                    <div style="width: 100%;">
                                        <div style="padding: 0 0px; width: 500px; float: left; font-size: 14px; text-align: left; max-height: 393px; overflow: auto;">
                                            <p><span style="color:rgb(255, 0, 0)"><strong>Now.vn TP. HCM</strong></span><br>
Địa chỉ: Lầu 8, Jabes Building, 244 Cống Quỳnh, Q.1, TP.HCM<br>
Điện thoại: 1900 2042<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn<br>
Giờ làm việc: 08:30 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Now.vn Hà Nội</strong></span><br>
Địa chỉ: Tầng 3, Tòa nhà 101 Láng Hạ, 101 Láng Hạ, Đống Đa, Hà Nội<br>
Điện thoại: (04) 3201 1228<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/ha-noi<br>
Giờ làm việc: 08:30 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Now.vn Đà Nẵng</strong></span><br>
Địa chỉ: Tầng 9, Tòa nhà VietNam Post Đà Nẵng, 155 Nguyễn Văn Linh, P. Vĩnh Trung, Q. Thanh Khê, Đà Nẵng<br>
Điện thoại: (0236) 3651 968<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/da-nang<br>
Giờ làm việc: 9:00 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Huế</strong></span><br>
Địa chỉ: Tầng 7 toà nhà HCC, 28 Lý Thường Kiệt, TP Huế<br>
Điện thoại: (0236) 3651 968<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/hue<br>
Giờ làm việc: 9:00 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Nha Trang</strong></span><br>
Địa chỉ: 6B Vạn Kiếp, Phường Phước Tân, Nha Trang<br>
Điện thoại: (0236) 3651 968<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/khanh-hoa<br>
Giờ làm việc: 9:00 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Cần Thơ</strong></span><br>
Địa chỉ: Tầng 5 toà nhà STS, 11B Đại Lộ Hoà Bình, P. Tân An, Q.Ninh Kiều, TP. Cần Thơ<br>
Điện thoại: (0292) 3 739 500 – 0901 242 313<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/can-tho<br>
Giờ làm việc: 9:00 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Hải Phòng</strong></span><br>
Địa chỉ: Tầng 6 toà nhà Pvcom Bank, 152 Hoàng Văn Thụ, Hải Phòng<br>
Điện thoại: (0225) 6 584 999&nbsp;<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/hai-phong<br>
Giờ làm việc: 9:00 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

<p><span style="color:rgb(255, 0, 0)"><strong>Biên Hoà</strong></span><br>
Địa chỉ: Lầu 18 toà nhà Pegasus Plaza, 53 – 55 Võ Thị Sáu, P.Quyết Thắng, Biên Hoà<br>
Điện thoại: 0899. 909. 919&nbsp;<br>
Email: info@deliverynow.vn<br>
Website: https://www.now.vn/<br>
Giờ làm việc: 9:00 AM - 6:00 PM từ Thứ 2 - Thứ 6</p>

                                        </div>
                                        <div style="padding: 0 0px; float: right; width: 450px;">
                                            
<div style="border-radius:5px; border:#ddd 1px solid; background:#fff; padding:20px;">
<form action="https://www.now.vn/lien-he" id="addNewContactForm" method="post" class="ng-pristine ng-valid"><input id="SystemName" name="SystemName" type="hidden" value="">        <div>
            
            <div>
                <input id="FullName" name="FullName" placeholder="Full name" style="border-bottom: #eee 1px solid;" type="text" value="">
            <div id="FullNameError" style="color: Red; padding: 5px 0px 0px 10px; display: none">Input full name please</div>
        </div>
    </div>
    <div>
        
        <div>
            <input id="Address" name="Address" placeholder="Address" style="border-bottom: #eee 1px solid;" type="text" value="">
            <div id="AddressError" style="color: Red; padding: 5px 0px 0px 10px; display: none">Input address please</div>
            </div>
        </div>
        <div>
            <input id="Phone" name="Phone" placeholder="Phone" style="border-bottom: #eee 1px solid;" type="text" value="">
            <div id="PhoneError" style="color: Red; padding: 5px 0px 0px 10px; display: none">Input phone please</div>
        </div>
        <div>
            <input id="EmailContact" name="Email" placeholder="Email" style="border-bottom: #eee 1px solid;" type="text" value="">
            <div id="EmailError" style="color: Red;padding:5px 0px 0px 10px;display: none">Input email please</div>
        </div>
        <div style="background:#fff;">
            <textarea cols="75" id="Content" name="Content" placeholder="Content" rows="10" style="font-size: 14px;padding: 10px 0;border: none;color: #666;border-bottom: #eee 1px solid;"></textarea>
            <div id="ContentError" style="color: Red;padding:5px 0px 0px 10px;display: none">Content is required</div>
        </div>
        <div>
                <p style="margin-top: 18px;">
                    <input type="checkbox" name="IsUsedPos" class="filled-in" id="filled-in-box">
                    <label style="font-size: 13px;" for="filled-in-box">Tôi muốn dùng thử phần mềm quản lý nhà hàng <a href="https://www.foodypos.vn/" target="_blank" title="foodypos.vn" style=" vertical-align: middle;margin-top: 3px;display: inline-block;"><img src="now/images/logo-small-pos.jpg" alt=""></a></label>              </p><div>(Tìm hiểu thêm về phần mềm quản lý nhà hàng <span style="color: #EC1F27;font-weight: bold;">Foody</span><span style="color: #1B67B2;font-weight: bold;">POS </span> <a href="https://www.foodypos.vn/" target="_blank" title="foodypos.vn" style="text-decoration: underline;"> tại đây</a>)</div>
                <p></p>
        </div>
        <div style="margin-top: 20px;">
            <input type="submit" value="Send contact" class="button" style="border: #ddd 1px solid;padding: 15px;width: 300px;font-size: 14px;text-transform: uppercase;">
            
            <div id="result-msg" style="color: Red; padding: 5px 0px 0px 10px; display:none"></div>
        </div>
</form></div>
...
<script type="text/javascript">
    autoHidePlaceHolder('#FullName');
    autoHidePlaceHolder('#Address');
    autoHidePlaceHolder('#Phone');
    autoHidePlaceHolder('#EmailContact');
    autoHidePlaceHolder('#Content');
    ...
    function checkValidate(){
        ...
        //return $('#addNewContactForm').validdate();
        //$.watermark.hideAll();
        if (check) {
            $('#result-msg').show();
        }
    ...
    function autoHidePlaceHolder(el) {
    ...
    $('#addNewContactForm').submit(function (e) {
        e.preventDefault();
        $('[name=IsUsedPos]').val($('[name=IsUsedPos]').is(":checked"));
        if (checkValidate()) {
            $.ajax({
                type: 'POST',
    ...
    <div class="container-footer">
        ...
        <div class="container-inner">
            ...
            <div class="block-last">
                ...
                <p>Address: Floor 8, Jabes Building 1</p><p>244 Cong Quynh, Pham Ngu Lao Ward, Dist 1, HCM</p><p>Business registration certificate No: 0311828036</p><p>Planning and Investment Department Of TPHCM</p><p>issued date 11/06/2012</p>
...
</script>    <div class="container-popup-modal-finish">
...
<div id="new-app" class="modal modal-new-app">
    <div class="modal-content">
        ...
        <div class="info-now">
            ...
            <h3 class="title">Hello you</h3><p class="desc">We are pleased to inform you that our application  <span class="bold">DeliveryNow</span> is changed its name to </p>             <a href="javascript:void(0)" class="btn-now" title="ứng dụng Now"> <span class="bold">Now</span></a>             <p class="update-version">Update new version</p>
            <div class="down-apps">
        ...
        <div class="box-now-merchant clearfix">
            ...
            <div class="info-merchant">
                <h3 class="title">NowMerchant</h3><p class="font14" style="margin-top:0; line-height: 18px;">App for merchants to <br><b> Receive orders</b> and<b> Check revenue...</b></p>
