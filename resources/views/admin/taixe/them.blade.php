...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-7" style="padding-bottom:120px">
            ...
            @endif
            <form action="{{ route('admin.taixe.them') }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{!! csrf_token()!!}">
                <div class="form-group">
                    <label>Tên tài xế</label>
                    <input class="form-control" name="txtTen" placeholder="Nhập tên tài xế" />
                </div>
                <div class="form-group">
                    <label>Ngày Sinh</label>
                    <input class="form-control" name="txtngaysinh" placeholder="Nhập ngày sinh" type="date" />
                </div>
                <div class="form-group">
